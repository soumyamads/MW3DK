 ...
 */
public class AuthorizationsFragment extends Fragment implements View.OnClickListener{
...
//    @Optional @InjectView(R.id.spinner2) Spinner spinner2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.authorization_layout, container, false);
