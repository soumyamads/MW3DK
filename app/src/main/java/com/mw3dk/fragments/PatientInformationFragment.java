 ...
 */
public class PatientInformationFragment extends Fragment implements View.OnClickListener{
...
//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.patient_information, container, false);
...
//            view.findViewById(R.id.addnewpatient).setOnClickListener(this);
        view.findViewById(R.id.sgninbtn).setOnClickListener(this);
